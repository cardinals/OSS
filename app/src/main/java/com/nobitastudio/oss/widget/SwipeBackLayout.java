...
public class SwipeBackLayout extends QMUIWindowInsetLayout {
    ...
    public static void offsetInEdgeTouch(View view, int edgeFlag, int offset) {
    ...
    public static void offsetInScroll(View view, int edgeFlag, int targetOffset) {
        if (edgeFlag == EDGE_BOTTOM) {
